...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if s:is_dark
    let g:terminal_ansi_colors = ['1A1B26', 'A36588', '7A80C2', '7A7CC2',
                                \ '7065A3', '9A9CE6', '9AA0E6', 'FFFFFF',
                                \ '3D3950', 'C27AA2', '9AA0E6', 'AAACF0',
                                \ '877AC2', 'AAACF0', 'AAB0F0', 'FFFFFF']
  else
    " Lighter colors for light theme
    let g:terminal_ansi_colors = ['FFFFFF', 'E69AC4', 'AAB0F0', 'AAACF0',
                                \ 'A79AE6', 'CCCDFF', 'CCD0FF', '5C5D82',
                                \ 'FFFFFF', 'F0AAD1', 'CCD0FF', 'CCCDFF',
                                \ 'B6AAF0', 'CCCDFF', 'CCD0FF', '1A1B26']
  endif
...
if &background == 'dark'
  ...
  hi Pmenu guibg=#5C5D82 guifg=#FFFFFF gui=NONE cterm=NONE
  hi StatusLine guifg=#FFFFFF guibg=#5C5D82 gui=NONE cterm=NONE
  hi StatusLineNC guifg=#FFFFFF guibg=#3D3950 gui=NONE cterm=NONE
  ...
  hi NeoTreeWinSeparator guifg=#3D3950 guibg=NONE gui=NONE cterm=NONE
  ...
  hi TabLine guifg=#FFFFFF guibg=#5C5D82 gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#1A1B26 guibg=#CCD0FF gui=bold cterm=bold
  hi TabLineSeparator guifg=#656AA3 guibg=#5C5D82 gui=NONE cterm=NONE

  " Interactive elements with dynamic contrast
  hi Search guifg=#3D3950 guibg=#AAB0F0 gui=NONE cterm=NONE
  hi Visual guifg=#3D3950 guibg=#9AA0E6 gui=NONE cterm=NONE
  hi MatchParen guifg=#3D3950 guibg=#CCD0FF gui=bold cterm=bold
  ...
  hi WhichKeyFloat guibg=#3D3950 guifg=NONE gui=NONE cterm=NONE

  " Selection and hover highlights with inverted colors
  hi CursorColumn guifg=NONE guibg=#5C5D82 gui=NONE cterm=NONE
  hi Cursor guibg=#FFFFFF guifg=#1A1B26 gui=NONE cterm=NONE
  hi lCursor guibg=#FFFFFF guifg=#1A1B26 gui=NONE cterm=NONE
  hi CursorIM guibg=#FFFFFF guifg=#1A1B26 gui=NONE cterm=NONE
  hi TermCursor guibg=#FFFFFF guifg=#1A1B26 gui=NONE cterm=NONE
  hi TermCursorNC guibg=#FFFFFF guifg=#1A1B26 gui=NONE cterm=NONE
  ...
  hi QuickFixLine guifg=#3D3950 guibg=#9AA0E6 gui=NONE cterm=NONE
  hi IncSearch guifg=#3D3950 guibg=#CCD0FF gui=NONE cterm=NONE
  hi NormalNC guibg=#3D3950 guifg=#FFFFFF gui=NONE cterm=NONE
  hi Directory guifg=#AAB0F0 guibg=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=#3D3950 guibg=#CCD0FF gui=bold cterm=bold

  " Add highlight groups for focused items with inverted colors
  hi CursorLineFold guifg=#CCD0FF guibg=#3D3950 gui=NONE cterm=NONE
  hi FoldColumn guifg=#FFFFFF guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#FFFFFF guibg=#5C5D82 gui=italic cterm=italic
  ...
  hi NeoTreeGitUntracked guifg=#7A7CC2 guibg=NONE gui=NONE cterm=NONE
  ...
  " hi NeoTreeCursorLine guibg=#9AA0E6 guifg=#1A1B26 gui=bold cterm=bold
  ...
  hi WinBar guifg=#FFFFFF guibg=#5C5D82 gui=bold cterm=bold
  hi WinBarNC guifg=#FFFFFF guibg=#3D3950 gui=NONE cterm=NONE
  hi ExplorerSnack guibg=#CCD0FF guifg=#1A1B26 gui=bold cterm=bold
  hi BufferTabpageFill guibg=#1A1B26 guifg=#FFFFFF gui=NONE cterm=NONE
  ...
  hi BufferCurrentSign guifg=#CCD0FF guibg=#3D3950 gui=NONE cterm=NONE
  hi BufferVisible guifg=#FFFFFF guibg=#5C5D82 gui=NONE cterm=NONE
  hi BufferVisibleMod guifg=#FFFFFF guibg=#5C5D82 gui=NONE cterm=NONE
  hi BufferVisibleSign guifg=#9AA0E6 guibg=#3D3950 gui=NONE cterm=NONE
  hi BufferInactive guifg=#FFFFFF guibg=#3D3950 gui=NONE cterm=NONE
  hi BufferInactiveMod guifg=#656AA3 guibg=#3D3950 gui=NONE cterm=NONE
  hi BufferInactiveSign guifg=#656AA3 guibg=#3D3950 gui=NONE cterm=NONE
  ...
  hi Normal guibg=NONE guifg=#1A1B26 gui=NONE cterm=NONE
  hi Pmenu guibg=#FFFFFF guifg=#1A1B26 gui=NONE cterm=NONE
  hi StatusLine guifg=#FFFFFF guibg=#4B4C7D gui=NONE cterm=NONE
  hi StatusLineNC guifg=#1A1B26 guibg=#FFFFFF gui=NONE cterm=NONE
  hi VertSplit guifg=#4B4C7D guibg=NONE gui=NONE cterm=NONE
  hi LineNr guifg=#4B4C7D guibg=NONE gui=NONE cterm=NONE
  hi SignColumn guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi FoldColumn guifg=#3D3950 guibg=NONE gui=NONE cterm=NONE

  " NeoTree with transparent background including unfocused state
  hi NeoTreeNormal guibg=NONE guifg=#1A1B26 gui=NONE cterm=NONE
  hi NeoTreeEndOfBuffer guibg=NONE guifg=#1A1B26 gui=NONE cterm=NONE
  hi NeoTreeFloatNormal guibg=NONE guifg=#1A1B26 gui=NONE cterm=NONE
  ...
  " TabLine highlighting with complementary accents
  hi TabLine guifg=#1A1B26 guibg=#FFFFFF gui=NONE cterm=NONE
  hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#FFFFFF guibg=#302952 gui=bold cterm=bold
  hi TabLineSeparator guifg=#4B4C7D guibg=#FFFFFF gui=NONE cterm=NONE

  " Interactive elements with complementary contrast
  hi Search guifg=#FFFFFF guibg=#423A6B gui=NONE cterm=NONE
  hi Visual guifg=#FFFFFF guibg=#4B4C7D gui=NONE cterm=NONE
  ...
  hi CmpItemAbbrMatchFuzzy guifg=#423A6B guibg=NONE gui=bold cterm=bold
  hi CmpItemMenu guifg=#3D3950 guibg=NONE gui=italic cterm=italic
  hi CmpItemAbbr guifg=#1A1B26 guibg=NONE gui=NONE cterm=NONE
  hi CmpItemAbbrDeprecated guifg=#5C5D82 guibg=NONE gui=strikethrough cterm=strikethrough

  " Specific menu highlight groups
  hi WhichKey guifg=#302952 guibg=NONE gui=NONE cterm=NONE
  hi WhichKeySeparator guifg=#5C5D82 guibg=NONE gui=NONE cterm=NONE
  hi WhichKeyGroup guifg=#544B7D guibg=NONE gui=NONE cterm=NONE
  hi WhichKeyDesc guifg=#423A6B guibg=NONE gui=NONE cterm=NONE
  hi WhichKeyFloat guibg=#FFFFFF guifg=NONE gui=NONE cterm=NONE

  " Selection and hover highlights with inverted colors
  hi CursorColumn guifg=NONE guibg=#FFFFFF gui=NONE cterm=NONE
  hi Cursor guibg=#1A1B26 guifg=#FFFFFF gui=NONE cterm=NONE
  hi lCursor guibg=#FFFFFF guifg=#1A1B26 gui=NONE cterm=NONE
  hi CursorIM guibg=#FFFFFF guifg=#1A1B26 gui=NONE cterm=NONE
  hi TermCursor guibg=#1A1B26 guifg=#FFFFFF gui=NONE cterm=NONE
  hi TermCursorNC guibg=#FFFFFF guifg=#1A1B26 gui=NONE cterm=NONE
  hi CursorLine guibg=NONE ctermbg=NONE gui=underline cterm=underline
  hi CursorLineNr guifg=#302952 guibg=NONE gui=bold cterm=bold

  hi QuickFixLine guifg=#FFFFFF guibg=#423A6B gui=NONE cterm=NONE
  hi IncSearch guifg=#FFFFFF guibg=#302952 gui=NONE cterm=NONE
  hi NormalNC guibg=#FFFFFF guifg=#3D3950 gui=NONE cterm=NONE
  ...
  hi FoldColumn guifg=#3D3950 guibg=NONE gui=NONE cterm=NONE
  hi Folded guifg=#1A1B26 guibg=#FFFFFF gui=italic cterm=italic

  " File explorer specific highlights
  hi NeoTreeNormal guibg=NONE guifg=#1A1B26 gui=NONE cterm=NONE
  hi NeoTreeEndOfBuffer guibg=NONE guifg=#1A1B26 gui=NONE cterm=NONE
  hi NeoTreeRootName guifg=#302952 guibg=NONE gui=bold cterm=bold
  hi NeoTreeFileName guifg=#1A1B26 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeFileIcon guifg=#423A6B guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeDirectoryName guifg=#423A6B guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeDirectoryIcon guifg=#423A6B guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitModified guifg=#544B7D guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitAdded guifg=#57598F guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitDeleted guifg=#A36588 guibg=NONE gui=NONE cterm=NONE
  hi NeoTreeGitUntracked guifg=#7A7CC2 guibg=NONE gui=NONE cterm=NONE
  ...
  " File explorer cursor highlights with strong contrast
  " hi NeoTreeCursorLine guibg=#423A6B guifg=#FFFFFF gui=bold cterm=bold
  " hi! link NeoTreeCursor NeoTreeCursorLine
  " hi! link NeoTreeCursorLineSign NeoTreeCursorLine

  " Use wallbash colors for explorer snack in light mode
  hi WinBar guifg=#1A1B26 guibg=#FFFFFF gui=bold cterm=bold
  hi WinBarNC guifg=#3D3950 guibg=#FFFFFF gui=NONE cterm=NONE
  hi ExplorerSnack guibg=#302952 guifg=#FFFFFF gui=bold cterm=bold
  hi BufferTabpageFill guibg=#FFFFFF guifg=#5C5D82 gui=NONE cterm=NONE
  ...
  hi BufferVisible guifg=#1A1B26 guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferVisibleMod guifg=#3D3950 guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferVisibleSign guifg=#544B7D guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferInactive guifg=#5C5D82 guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferInactiveMod guifg=#7065A3 guibg=#FFFFFF gui=NONE cterm=NONE
  hi BufferInactiveSign guifg=#7065A3 guibg=#FFFFFF gui=NONE cterm=NONE
...
hi FloatBorder guifg=#4B4C7D guibg=NONE gui=NONE cterm=NONE
hi SignColumn guifg=NONE guibg=NONE gui=NONE cterm=NONE
hi DiffAdd guifg=#FFFFFF guibg=#7A80C2 gui=NONE cterm=NONE
hi DiffChange guifg=#FFFFFF guibg=#6567A3 gui=NONE cterm=NONE
hi DiffDelete guifg=#FFFFFF guibg=#A36588 gui=NONE cterm=NONE
hi TabLineFill guifg=NONE guibg=NONE gui=NONE cterm=NONE

" Fix selection highlighting with proper color derivatives
hi TelescopeSelection guibg=#CCCDFF guifg=#1A1B26 gui=bold cterm=bold
hi TelescopeSelectionCaret guifg=#FFFFFF guibg=#CCCDFF gui=bold cterm=bold
hi TelescopeMultiSelection guibg=#9A9CE6 guifg=#1A1B26 gui=bold cterm=bold
hi TelescopeMatching guifg=#C27AA2 guibg=NONE gui=bold cterm=bold

" Minimal fix for explorer selection highlighting
hi NeoTreeCursorLine guibg=#CCCDFF guifg=#1A1B26 gui=bold

" Fix for LazyVim menu selection highlighting
hi Visual guibg=#FFCCE8 guifg=#1A1B26 gui=bold
hi CursorLine guibg=NONE ctermbg=NONE gui=underline cterm=underline
hi PmenuSel guibg=#FFCCE8 guifg=#1A1B26 gui=bold
hi WildMenu guibg=#FFCCE8 guifg=#1A1B26 gui=bold
...
augroup FixNeoTreeBackground
  ...
  autocmd ColorScheme,VimEnter * if &background == 'dark' |
    \ hi NeoTreeCursorLine guibg=#CCCDFF guifg=#1A1B26 gui=bold cterm=bold |
    \ hi NvimTreeCursorLine guibg=#CCCDFF guifg=#1A1B26 gui=bold cterm=bold |
    \ else |
